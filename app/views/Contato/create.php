							...
							<div class="rows msg-form">	
							  <div class="col-3 position-relative">									
								...
								<div class="col-3">
									...
									<div class="col-3">
										<label>UF</label>
										<input name="estado" value="<?php echo isset($contato) ? $contato->uf : "" ?>" type="text" placeholder="Insira seu bairro" class="form-campo">						
									</div>
								<div class="col-6">
									<label>Bairro</label>
								...
								<div class="col-4 m-auto">
									<input type="hidden" name="id_cliente" value="<?php echo isset($contato) ? $contato->idcontato : null ?>" />
